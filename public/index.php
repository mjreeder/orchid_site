...
require __DIR__ . '/../src/api/health_comment.php';
...
require __DIR__ . '/../src/api/sprayed_comment.php';
...
require __DIR__ . '/../src/Model/Health_Comment.php';
...
require __DIR__ . '/../src/Model/Sprayed_Comment.php';
